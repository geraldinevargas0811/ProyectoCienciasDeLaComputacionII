...
export default function AlgorithmPage({ type }) {
  ...
  return <><PageHeader eyebrow="Búsquedas / Memoria interna" title={title} description={description} /><div className="lab-layout"><div className="lab-layout__controls"><ConfigurationPanel binary={binary} /><SearchInput /><ResultPanel /></div><div className="lab-layout__visual"><section className="panel"><h2>Visualización de memoria</h2><p className="panel__intro">Índice y valor almacenado en cada celda.</p><MemoryStructure values={binary ? [12, 25, 31, 47, 83] : undefined} /></section><VisualizationPanel /></div></div></>;
}
